<?php
// source: C:\xampp\htdocs\clones\netteSocials\tests\GalekTests\app/config/config.neon 

class Container_e7012c1e0a extends Nette\DI\Container
{
	protected $meta = array(
		'types' => array(
			...
			'App\Presenters\BasePresenter' => array(array('application.1', 'application.3')),
			'Nette\Application\UI\Presenter' => array(array('application.1', 'application.3')),
	...
	public function createServiceApplication__1()
	{
		...
		$service->google = $this->getService('23_Galek_Socials_Google_Config');
		$service->facebook = $this->getService('25_Galek_Socials_Facebook_Config');
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\clones\netteSocials\tests\GalekTests\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		return new Container_e7012c1e0a_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('C:\xampp\htdocs\clones\netteSocials\tests\GalekTests\app/../temp/cache/latte');
...
final class Container_e7012c1e0a_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_e7012c1e0a $container)
	{
